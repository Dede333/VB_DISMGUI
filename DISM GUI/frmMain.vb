...
Public Class frmMain
    ...
    Dim WIMMounted As Boolean = False           ' flag WIMMounted: WIMMounted = True (if wim is monted)
    ...
    ' 
    ' use for open a dialogue box OpenFile wim or other file
    ' save the result on txtWIM form variable (not in a global variable !)
    ...
    Private Sub btnOpenWIM_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOpenWIM.Click
        ...
        Else
            ...
            txtWIM.Text = strFileName                           ' form variable
        End If
    ...
    ' save the result on txtMount form variable (not in a global variable !)
    ...
    Private Sub btnOpenMount_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOpenMount.Click
        ...
        If dirs.Length = 0 AndAlso files.Length = 0 Then ' check if there is no directory or filename
    ...
    ' Sub btnMount_Click
    '
    ' Mount specify wim file (txtWim) with index (cmdIndex) on specify folder (txtMount)
    ' TODO: detect the number of Index present on wim file automaticaly
    '       and screen the description of wim from selected wim
    ...
    Private Sub btnMount_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnMount.Click
        ...
        Else
            txtMount.Text = Replace(txtMount.Text, """", "") ' prevent for name file with space
            strFolderName = txtMount.Text                    ' save path in global variable 
            strIndex = cmbIndex.Text
            txtWIM.Text = Replace(txtWIM.Text, """", "")     ' prevent for name file with space
            strWIM = txtWIM.Text                             ' save path in global variable
            BackgroundWorkerMount.RunWorkerAsync()
            frmProgress.ShowDialog()
            txtOutput.Text = txtOutput.Text & strOutput      ' update console messages
        End If
    End Sub
    ...
    Private Sub btnDismount_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDismount.Click
        strFolderName = txtMount.Text   ' save in globale variable strFolderName
        strIndex = cmbIndex.Text        ' save in globale variable strIndex 
        strWIM = txtWIM.Text            ' save in globale variable strWim
        txtOutput.Text = ""             ' clear the console view
        BackgroundWorkerDisMount.RunWorkerAsync()
        frmProgress.ShowDialog()
        txtOutput.Text = txtOutput.Text & strOutput  ' display the result
    End Sub
    ...
    Private Sub BackgroundWorkerMount_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorkerMount.DoWork
        ...
        txtOutput.Text = "Command line that ran is: dism.exe " & DISM.StartInfo.Arguments & vbCr
        DISM.Start()
    ...
    Private Sub BackgroundWorkerDisMount_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorkerDisMount.DoWork
        ...
        txtOutput.Text = "Command line that ran is: dism.exe " & DISM.StartInfo.Arguments
        DISM.Start()
        strOutput = strOutput & DISM.StandardOutput.ReadToEnd()
        DISM.WaitForExit()
